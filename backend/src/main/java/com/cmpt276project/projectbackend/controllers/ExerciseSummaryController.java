...
public class ExerciseSummaryController {
    ...
    try {
        Optional<ExerciseSummary> existingExerciseSummary = exerciseSummaryRepository.findByUidAndExerSumDate(exerciseSummary.getUid(), exerciseSummary.getExerSumDate());
     ...
     public ResponseEntity<Optional<ExerciseSummary>> getCompletedActivities(@PathVariable("userId") int userId, @PathVariable("date") String date) {
